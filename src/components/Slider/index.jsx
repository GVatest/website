    ...
    <div className='slider'>
      {SliderData.map((slide, index) => {
        return (
          ...
          >
            {index === current ? (
              <img src={slide.image} alt='solution pass' className='slider_image' />
            ) : 
            (
              <img src={slide.image} style={{display: "none"}} alt='solution pass' className='slider_image' />
            )}
          </div>
        );
      })}
